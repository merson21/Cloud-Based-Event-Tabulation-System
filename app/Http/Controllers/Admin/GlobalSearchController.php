...
class GlobalSearchController extends Controller
{
    private $models = [
        ...
        'Faq'          => 'cruds.faq.title',
        'Organization' => 'cruds.organization.title',
        'Partylist'    => 'cruds.partylist.title',
        'Candidate'    => 'cruds.candidate.title',
        'Voter'        => 'cruds.voter.title',
        'Title'        => 'cruds.title.title',
        'Category'     => 'cruds.category.title',
        'Criterion'    => 'cruds.criterion.title',
        'Judge'        => 'cruds.judge.title',
        'Participant'  => 'cruds.participant.title',
    ];
