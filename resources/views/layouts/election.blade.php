            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown user-menu">
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                        ...
                        @else
                            <img src="{{ $voterData->image->getUrl('thumb') }}" class="user-image img-circle elevation-2" alt="User Image">

                        @endif
                        <span class="d-none d-md-inline">{{ $voterData->name }}</span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <li class="user-header ">
                            ...
                            @else
                                <img src="{{ $voterData->image->getUrl('preview') }}" class="img-circle elevation-2" alt="User Image">

                            @endif

                            <p>
                                {{ $voterData->name }}
                                <small>{{$voterData->email}}</small>
                            </p>
                        </li>
                        ...
                        <li class="user-footer">
                                <form action="{{ url('e-voting/'.$slug.'/logout') }}" method="POST">
                                    @csrf
