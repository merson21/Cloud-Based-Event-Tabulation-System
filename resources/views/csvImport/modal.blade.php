    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">.TXT OR .CSV</h4>
                    ...
                    <div class='col-md-12'>
                        ...
                        <form class="form-horizontal" method="POST" action="{{ route($route, ['model' => $model]) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group{{ $errors->has('csv_file') ? ' has-error' : '' }}">
                                ...
                                <label for="csv_file" class="col-md-4 control-label">.TXT OR .CSV</label>
                            ...
                            <div class="form-group d-none">
                                <div class="col-md-6 col-md-offset-4">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="header" unchecked> @lang('global.app_file_contains_header_row')
                                        </label>
                                    </div>
                                </div>
                            </div>
