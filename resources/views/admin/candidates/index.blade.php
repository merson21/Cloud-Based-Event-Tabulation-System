                ...
                <tr>
                    ...
                    <td>
                        <select class="search" strict="true">
                            ...
                            @foreach(App\Models\Candidate::STATUS_RADIO as $key => $item)
                    ...
                    <td>
                        <select class="search">
                            <option value>{{ trans('global.all') }}</option>
                            @foreach($partylists as $key => $item)
...
{ data: 'partylist_name', name: 'partylist.name' },
{ data: 'position_position', name: 'position.position' },
{ data: 'name', name: 'name' },
