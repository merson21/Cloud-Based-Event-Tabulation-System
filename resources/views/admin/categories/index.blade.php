        ...
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Category">
            <thead>
                <tr>
                    ...
                    <th>
                        {{ trans('cruds.category.fields.lock') }}
                    </th>
                    <th>
                ...
                <tr>
                    ...
                    <td>
                        <select class="search" strict="true">
                            ...
                            @foreach(App\Models\Category::STATUS_RADIO as $key => $item)
                    ...
                    <td>
                        <select class="search" strict="true">
                            <option value>{{ trans('global.all') }}</option>
                            @foreach(App\Models\Category::PERCENTAGE_SELECT as $key => $item)
                                <option value="{{ $key }}">{{ $item }}</option>
                            @endforeach
                        </select>
                    </td>
...
{ data: 'partipants', name: 'partipants' },
